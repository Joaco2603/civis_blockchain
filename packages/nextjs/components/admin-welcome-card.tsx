        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="flex items-center">
              <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">Panel de Administración</h2>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">Gestión del sistema de votación descentralizada</p>
            {userDID && (
