      ...
      <CardContent>
            ...
            <ChartContainer>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <Bar dataKey="transactions" radius={[4, 4, 0, 0]} barSize={20}>
                      ...
                      if (active && payload && payload.length) {
                        return (
                          <div className="bg-white dark:bg-gray-800 p-2 rounded-md border shadow-sm">
                            ...
                            <p className="text-sm">{payload[0].value} transacciones</p>
                          </div>
                        )
                      }
                      return null
        ...
        <div className="mt-4 grid grid-cols-3 gap-4">
          <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-3 text-center">
            <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">5,530</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">Transacciones Totales</div>
          </div>

          <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-3 text-center">
            <div className="text-2xl font-bold text-green-600 dark:text-green-400">100%</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">Integridad Verificada</div>
          </div>
          ...
          <div className="bg-amber-50 dark:bg-amber-900/30 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400">Anomalías Detectadas</div>
          </div>
        </div>
      </CardContent>
    </Card>
