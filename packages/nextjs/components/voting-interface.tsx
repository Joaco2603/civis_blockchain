...
import { useContract, UseContractResult } from "@starknet-react/core";
import VotingContractABI from "~~/../snfoundry/contracts/target/dev/contracts_VotingContract.contract_class.json";
...
export function VotingInterface({ electionId }: VotingInterfaceProps) {
        ...
        items: [
          {
            type: "function",
            name: "vote",
            inputs: [{ name: "president_index", type: "core::felt252" }],
            outputs: [],
          ...
          },
          {
            ...
            inputs: [{ name: "proposal_name", type: "core::felt252" }],
            outputs: [],
            state_mutability: "external"
          },
          {
            type: "function",
            name: "get_proposal",
            inputs: [{ name: "proposal_index", type: "core::felt252" }],
  ...
  const handleVote = async () => {
    ...
    // await contract.invoke("vote", [
    //   hash.computeHashOnElements([BigInt(Number(selectedCandidate))])
    // ]);
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              Guarda este identificador para verificar tu voto en el futuro. Tu
              elección permanece anónima y privada.
            </AlertDescription>
          </Alert>
        </CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Selecciona un candidato para emitir tu voto
        </CardDescription>
      </CardHeader>
      <CardContent>
        <RadioGroup
        ...
        {votingState === "error" && (
          <Alert variant="destructive" className="mt-4">
            ...
            <AlertDescription>
              Ha ocurrido un error al procesar tu voto. Por favor, intenta
              nuevamente.
            </AlertDescription>
          </Alert>
        )}
      ...
      <CardFooter className="border-t pt-4 flex flex-col space-y-4">
        ...
        <p className="text-xs text-center text-gray-500 dark:text-gray-400">
          Tu voto será registrado de forma anónima y segura en la blockchain.
          Podrás verificar que tu voto fue contabilizado sin revelar tu
          elección.
        </p>
      </CardFooter>
    </Card>
