...
export function UserProfile() {
  ...
  const [email, setEmail] = useState("jpappa2603@gmail.com");
      ...
      <div className="md:col-span-1">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tu información personal y de identidad
            </CardDescription>
          </CardHeader>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="notify-elections">
                        Nuevas Elecciones
                      </Label>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        Recibe notificaciones sobre actualizaciones de la
                        plataforma
                      </p>
                    </div>
                    <Switch
