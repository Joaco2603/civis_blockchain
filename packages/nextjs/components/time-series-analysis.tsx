...
export function TimeSeriesAnalysis() {
  ...
  const getLines = () => {
    if (timeRange === "historical") {
      return [
        {
          dataKey: "Partido Democrático",
          stroke: "#3b82f6",
          name: "Partido Democrático"
        },
        {
          dataKey: "Alianza Progresista",
          stroke: "#ef4444",
          name: "Alianza Progresista"
        },
        {
          dataKey: "Unión Republicana",
          stroke: "#10b981",
          name: "Unión Republicana"
        },
        {
          dataKey: "Movimiento Ciudadano",
          stroke: "#f59e0b",
